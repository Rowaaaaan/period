...
apps                   = {
	...
	-- Scratch window
	scratch       = os.getenv("EDITOR") or "nvim" or
		"vim" .. " -c setlocal buftype=nofile noswapfile bufhidden=wipe nobuflisted",

	-- Your default file explorer
	explorer      = "thunar" or "pcmanfm",

	launcher      = "rofi -show-icons -show combi -combi-modi 'window,drun,run,emoji'",

	calculator    = "rofi -show calc",

	scrlocker     = os.getenv("HOME") .. "/.local/scripts/lock",

	powermenu     = os.getenv("HOME") .. "/.local/powermenu.sh",
